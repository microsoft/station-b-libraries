...
let dotnet cmd workingDir args =
...
Target.create "Azure" (fun _ ->
    ...
    deployment
    |> Deploy.execute "BCKG_REST_Server" Deploy.NoParameters
    |> ignore
)
...
Target.create "RunTests" (fun _ ->
    ...
    [ async { dotnet "watch run" serverTestsPath "--local --port 8085" }
